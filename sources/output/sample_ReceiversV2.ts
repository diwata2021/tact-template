...
function dictValueParserMultiMath(): DictionaryValue<MultiMath> {
 ...
 type ReceiversV2_init_args = {
    $$type: 'ReceiversV2_init_args';
}

function initReceiversV2_init_args(src: ReceiversV2_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
    };
}

async function ReceiversV2_init() {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initReceiversV2_init_args({ $$type: 'ReceiversV2_init_args' })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const ReceiversV2_errors: { [key: number]: { message: string } } = {
...
const ReceiversV2_types: ABIType[] = [
...
export class ReceiversV2 implements Contract {
    
    static async init() {
        return await ReceiversV2_init();
    }
    
    static async fromInit() {
        const init = await ReceiversV2_init();
        const address = contractAddress(0, init);
        return new ReceiversV2(address, init);
    }
    
    static fromAddress(address: Address) {
        return new ReceiversV2(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  ReceiversV2_types,
        getters: ReceiversV2_getters,
        receivers: ReceiversV2_receivers,
        errors: ReceiversV2_errors,
    };
